...
import { useFeaturedRugs } from "@/hooks/use-rugs"
...
export default function FeaturedRugs() {
  ...
  const { items, loading, error } = useFeaturedRugs(activeCategory)
          ...
          >
            {loading ? (
              ...
              <div className="flex w-full items-center justify-center py-8">
                <p className="text-gray-500 dark:text-gray-400">Failed to load featured rugs</p>
              </div>
            ) : (
